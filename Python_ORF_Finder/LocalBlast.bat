cd D:\School\HAN\2017-2018 (Bi2c)\Course 7\Tutor\Periode-7-Opdracht\Python_ORF_Finder
...
Result.txt
move Result.txt D:\School\HAN\2017-2018 (Bi2c)\Course 7\Tutor\Periode-7-Opdracht\Python_ORF_Finder
